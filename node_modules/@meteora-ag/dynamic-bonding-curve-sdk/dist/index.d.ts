...
import { Accounts, IdlTypes, BN, IdlAccounts, Program, ProgramAccount } from '@coral-xyz/anchor';
...
type TransferPoolCreatorAccounts = Accounts<DynamicBondingCurve['instructions']['21']>['transferPoolCreator'];
type WithdrawLeftoverAccounts = Accounts<DynamicBondingCurve['instructions']['22']>['withdrawLeftover'];
...
type BuildCurveWithMarketCapParam = BuildCurveBaseParam & {
    initialMarketCap: number;
    migrationMarketCap: number;
};
type BuildCurveWithTwoSegmentsParam = BuildCurveBaseParam & {
    initialMarketCap: number;
    migrationMarketCap: number;
    percentageSupplyOnMigration: number;
};
type BuildCurveWithLiquidityWeightsParam = BuildCurveBaseParam & {
    initialMarketCap: number;
    migrationMarketCap: number;
...
type CreateConfigAndPoolParam = CreateConfigParam & {
    preCreatePoolParam: PreCreatePoolParam;
};
type CreateConfigAndPoolWithFirstBuyParam = CreateConfigAndPoolParam & {
    firstBuyParam?: FirstBuyParam;
};
type CreatePoolWithFirstBuyParam = {
    createPoolParam: CreatePoolParam;
    firstBuyParam?: FirstBuyParam;
};
type CreatePoolWithPartnerAndCreatorFirstBuyParam = {
    createPoolParam: CreatePoolParam;
    partnerFirstBuyParam?: PartnerFirstBuyParam;
    creatorFirstBuyParam?: CreatorFirstBuyParam;
};
type PreCreatePoolParam = {
    name: string;
    symbol: string;
    uri: string;
    poolCreator: PublicKey;
...
type MigrateToDammV2Param = MigrateToDammV1Param;
...
type ClaimPartnerTradingFeeWithQuoteMintSolParam = ClaimPartnerTradingFeeWithQuoteMintNotSolParam & {
    tempWSolAcc: PublicKey;
};
...
type ClaimCreatorTradingFee2Param = {
    creator: PublicKey;
    payer: PublicKey;
    pool: PublicKey;
    maxBaseAmount: BN;
...
type ClaimCreatorTradingFeeWithQuoteMintNotSolParam = {
    creator: PublicKey;
    payer: PublicKey;
    feeReceiver: PublicKey;
    pool: PublicKey;
...
type ClaimCreatorTradingFeeWithQuoteMintSolParam = ClaimCreatorTradingFeeWithQuoteMintNotSolParam & {
    tempWSolAcc: PublicKey;
};
...
type TransferPoolCreatorParam = {
    virtualPool: PublicKey;
    creator: PublicKey;
    newCreator: PublicKey;
};
type WithdrawMigrationFeeParam = {
    virtualPool: PublicKey;
    sender: PublicKey;
    feePayer?: PublicKey;
};
...
declare class PoolService extends DynamicBondingCurveProgram {
     ...
     */
    createConfigAndPool(createConfigAndPoolParam: CreateConfigAndPoolParam): Promise<Transaction>;
    /**
     ...
     */
    createConfigAndPoolWithFirstBuy(createConfigAndPoolWithFirstBuyParam: CreateConfigAndPoolWithFirstBuyParam): Promise<{
     ...
     */
    createPoolWithFirstBuy(createPoolWithFirstBuyParam: CreatePoolWithFirstBuyParam): Promise<{
        createPoolTx: Transaction;
        swapBuyTx: Transaction | undefined;
    }>;
    /**
     ...
     */
    createPoolWithPartnerAndCreatorFirstBuy(createPoolWithPartnerAndCreatorFirstBuyParam: CreatePoolWithPartnerAndCreatorFirstBuyParam): Promise<{
        createPoolTx: Transaction;
     ...
     */
    swapQuoteExactOut(swapQuoteExactOutParam: SwapQuoteExactOutParam): QuoteResult;
}
...
declare class PartnerService extends DynamicBondingCurveProgram {
     ...
     * @returns A claim trading fee transaction
     */
    claimPartnerTradingFee2(claimTradingFee2Param: ClaimTradingFee2Param): Promise<Transaction>;
    /**
     ...
     */
    partnerWithdrawMigrationFee(withdrawMigrationFeeParams: WithdrawMigrationFeeParam): Promise<Transaction>;
}
...
declare class CreatorService extends DynamicBondingCurveProgram {
     ...
     * @returns A claim creator trading fee transaction
     */
    claimCreatorTradingFee2(claimCreatorTradingFee2Param: ClaimCreatorTradingFee2Param): Promise<Transaction>;
    /**
     ...
     */
    transferPoolCreator(transferPoolCreatorParams: TransferPoolCreatorParam): Promise<Transaction>;
    /**
     ...
     */
    creatorWithdrawMigrationFee(withdrawMigrationFeeParams: WithdrawMigrationFeeParam): Promise<Transaction>;
}
...
declare const MAX_MIGRATION_FEE_PERCENTAGE = 50;
 ...
 */
declare function getMigratedPoolFeeParams(migrationOption: MigrationOption, migrationFeeOption: MigrationFeeOption, migratedPoolFee?: MigratedPoolFee): {
    collectFeeMode: CollectFeeMode;
    dynamicFee: DammV2DynamicFeeMode;
    poolFeeBps: number;
};
 ...
 */
declare function buildCurveWithMarketCap(buildCurveWithMarketCapParam: BuildCurveWithMarketCapParam): ConfigParameters;
/**
 * Build a custom constant product curve by market cap
 * @param buildCurveWithTwoSegmentsParam - The parameters for the custom constant product curve by market cap
 * @returns The build custom constant product curve by market cap
 */
declare function buildCurveWithTwoSegments(buildCurveWithTwoSegmentsParam: BuildCurveWithTwoSegmentsParam): ConfigParameters;
/**
 ...
 */
declare function buildCurveWithLiquidityWeights(buildCurveWithLiquidityWeightsParam: BuildCurveWithLiquidityWeightsParam): ConfigParameters;
 ...
 * @returns Next sqrt price
 */
declare function getNextSqrtPriceFromAmountQuoteRoundingUp(sqrtPrice: BN$1, liquidity: BN$1, amount: BN$1): BN$1;
/**
 ...
 * @returns Next sqrt price
 */
declare function getNextSqrtPriceFromAmountBaseRoundingDown(sqrtPrice: BN$1, liquidity: BN$1, amount: BN$1): BN$1;
/**
 ...
 * @returns Next sqrt price
 */
declare function getNextSqrtPriceFromOutput(sqrtPrice: BN$1, liquidity: BN$1, outAmount: BN$1, isQuote: boolean): BN$1;
 ...
 */
declare function getIncludedFeeAmount(tradeFeeNumerator: BN$1, excludedFeeAmount: BN$1): BN$1;
/**
 ...
 */
declare function getSwapResultFromOutAmount(poolState: VirtualPool, configState: PoolConfig, outAmount: BN$1, feeMode: FeeMode, tradeDirection: TradeDirection, currentPoint: BN$1): QuoteResult;
/**
 ...
 */
declare function getInAmountFromBaseToQuote(configState: PoolConfig, currentSqrtPrice: BN$1, outAmount: BN$1): SwapAmount;
/**
 ...
 * @returns Swap amount with input calculated
 */
declare function getInAmountFromQuoteToBase(configState: PoolConfig, currentSqrtPrice: BN$1, outAmount: BN$1): SwapAmount;
/**
 ...
 */
declare function swapQuoteExactOut(virtualPool: VirtualPool, config: PoolConfig, swapBaseForQuote: boolean, outAmount: BN$1, slippageBps: number, hasReferral: boolean, currentPoint: BN$1): QuoteResult;
