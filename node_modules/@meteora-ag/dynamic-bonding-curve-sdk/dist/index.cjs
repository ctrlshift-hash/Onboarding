...
function calculateQuoteExactInAmount(config, virtualPool, currentPoint) {
  ...
  if (config.collectFeeMode === 0 /* QuoteToken */) {
    const baseFeeNumerator = getBaseFeeNumerator(
