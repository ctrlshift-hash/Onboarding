...
function getNextSqrtPriceFromAmountQuoteRoundingUp(sqrtPrice, liquidity, amount) {
  ...
  const step2 = SafeMath.sub(step1, new BN4(1));
...
function getIncludedFeeAmount(tradeFeeNumerator, excludedFeeAmount) {
  const includedFeeAmount = mulDiv(
    excludedFeeAmount,
    new BN12(FEE_DENOMINATOR),
    new BN12(FEE_DENOMINATOR).sub(tradeFeeNumerator),
    0 /* Up */
  );
...
function getSwapResultFromOutAmount(poolState, configState, outAmount, feeMode, tradeDirection, currentPoint) {
  ...
  tradeFeeNumerator = BN12.min(tradeFeeNumerator, new BN12(MAX_FEE_NUMERATOR));
...
var PoolService = class extends DynamicBondingCurveProgram {
  ...
  async createPoolWithFirstBuy(createPoolWithFirstBuyParam) {
    ...
    let swapBuyTx;
    if (createPoolWithFirstBuyParam.firstBuyParam && createPoolWithFirstBuyParam.firstBuyParam.buyAmount.gt(new BN13(0))) {
      swapBuyTx = await this.swapBuyTx(
...
export {
  ...
  getNextSqrtPriceFromAmountBaseRoundingDown,
  getNextSqrtPriceFromAmountBaseRoundingUp,
  getNextSqrtPriceFromAmountQuoteRoundingDown,
  getNextSqrtPriceFromAmountQuoteRoundingUp,
